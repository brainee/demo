...
;(function (){
  ...
  */
  ...
  var url = arguments[0], html = arguments[1], fetchedDatas = arguments[2],funcStr;
    ...
    return JSON.stringify({bProceed: (leftmodels.length + _.size(fetchedDatas) < models.length), models: leftmodels, fetchedDatas: arguments[2]});   
  };

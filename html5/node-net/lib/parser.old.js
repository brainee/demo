...
var globalspaces = ["hotel", "CommentDeal","ddrUtils","NewsCommon","travelsFn","ShopsDataCommon","travelsFn","GsPlaceTtdList","commonUtil", "ddrParser", "ShopsListData", "ShopsBrandListData", "ShopsGlanceDetailData", "ShopsNearbyData", "Lipin"];
var Lizard = Lizard||{};
  ...
  */
  ...
  _Lizard.prototype = {
    ...
    render:function(datas){
      ...
      var indexMap = {}, models = this.getModels();
    ...
    //throw JSON.stringify(indexMap) + '|||||||||| ' + JSON.stringify(datas)
    
    this.ohtml = this.html;
      var TDK={};
      var TDKStr = "";
      var setTDK = this.config.model?this.config.model.setTDK:null;
      if (setTDK){
        TDK = setTDK(datas);
      }
      ...
      if (this.config.model && this.config.model.filter){          
        var context = {};
        _.each(globalspaces, function(space){
       ...
       // console.log(this.config.model.filter.toString());
    //   console.log(context);
      //  console.log('---------');
     ...
     // return '1231';
      ...
      ret.viewport = ('<div id="' + id + '" page-url="'+ this.url.replace('h5seo.mobile.ctripcorp.com', 'm.ctrip.com') +'">'
              + ret.viewport
